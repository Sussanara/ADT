...
export const HomeUserTrial = () => {
  ...
  const dataFalsa = [
    { id: 1, name: "mayo", stock: 123, sold_stock: 33, price: 2500,is_active: true },
    { id: 2, name: "coca-cola", stock: 77, sold_stock: 25, price: 2000 ,is_active: true },
    { id: 3, name: "lays", stock: 322, sold_stock: 200, price: 500 ,is_active: true },
    { id: 4, name: "donuts", stock: 44, sold_stock: 12, price: 900 ,is_active: true },
    { id: 5, name: "orange", stock: 65, sold_stock: 33, price: 2000 ,is_active: true },
    { id: 6, name: "bimbo", stock: 22, sold_stock: 11, price: 4500 ,is_active: true },
    { id: 7, name: "sprite", stock: 83, sold_stock: 32, price: 2000 ,is_active: true },
    { id: 8, name: "chettos", stock: 287, sold_stock: 22, price: 500 ,is_active: true },
    { id: 9, name: "chocolitos", stock: 50, sold_stock: 12, price: 600 ,is_active: true },
    { id: 10, name: "lapiz", stock: 300, sold_stock: 147, price: 100 ,is_active: true },
  ];
        ...
        >
          <Card sx={{ maxWidth: 280, maxHeight: 460 }}>
            <CardMedia
              ...
              width=""
              height="240"
              image="../asset/pruebagratuita.png"
              alt=""
            />
